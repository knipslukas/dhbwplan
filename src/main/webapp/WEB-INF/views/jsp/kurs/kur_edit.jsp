...
<!-- 	        Präsenzzeitraum Formular -->
	       <form class="pb-3 js-form-dozanleg">
	        ...
	        <div class="form-group row">
	                ...
	                <div class="col-3">
						<input type="date" name="von" class="form-control js-form-von" id=test placeholder="Neues Startdatum" value="<fmt:formatDate type = "date" value = "${praesenzzeitraum.von}" pattern="dd-MM-YYYY" />	                
	                </div>
	        </div>    
	        ...
	        <div class="form-group row">
	                ...
	                <div class="col-3">
						<input type="date" name="bis" class="form-control js-form-bis" placeholder="Neues Enddatum" value="<fmt:formatDate type = "date" value = "${praesenzzeitraum.bis}" pattern="dd-MM-YYYY" />	                
	                </div>
	         </div> 
