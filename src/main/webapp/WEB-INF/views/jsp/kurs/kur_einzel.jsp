    	...
    	<div class="row">
	    	<div class="card col-sm-12 col-md-11 col-lg-8 mx-auto doz-card">
	    		<div class="card-header text-center">
	    			...
	    			<h1 class="card-title"><strong>${kurs.anrede} </strong></h1>
	   			...
	   			<div class="card-body">
	   				...
	   				<div class="row mt-4 text-center border border-left-0 border-right-0 border-top-0">
	   					<div class="col-6"><p><strong>Studiengang</strong></p></div>
	   					<div class="col-6">
	   						<p>${kurs.studiengang}</p>
	   					</div>
	   					<div class="col-6"><p><strong>Studienrichtung</strong></p></div>
	   					<div class="col-6">
	   						<p>${kurs.studienrichtung}</p>
	   					</div>
	   				</div>
	   				<div class="row mt-4 text-center border border-left-0 border-right-0 border-top-0">
	   				...
	   				<div class="row mt-4 text-center border border-left-0 border-right-0 border-top-0">
	   					...
	   					<div class="col-6">
	   						<p>${kurs.studiengangsleiter}</p>
	   					</div>
	   				</div>
	   				<div class="row mt-4 text-center border border-left-0 border-right-0 border-top-0">
	   					<div class="col-6"><p><strong>Pr�senzzeitraum</strong></p></div>
	   					<div class="col-6">
	   						<p>Von ${kurs.zeitvon} bis ${kurs.zeitbis} </p>
	   					</div>
	   				</div>
		...
		<div class="modal-dialog modal-dialog-centered">
			<div class="modal-content">
				<div class="modal-body">
					...
					<h4>Wollen Sie wirklich ${kurs.anrede}  löschen?</h4>
				</div>
