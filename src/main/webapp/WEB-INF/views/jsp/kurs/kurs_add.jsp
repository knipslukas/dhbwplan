...
<template:template pageTitle="${pageTitle}">
	...
	<div class="container">
		...
		<div class="dhbw_content mt-5">
			<!-- Start Formular -->
			<form class="pb-3 js-form-dozanleg" method="POST" action="/kurs/add">
				...
				<form class="pb-3 js-form-dozanleg" method="POST" action="/praesenzzeitraum/add">
					...
					<div class="form-group row">
						...
						<div class="col-10">
							<input type="text" name="date_bis" class="form-control"
								placeholder="Datum bis wann eingeben" required>
						</div>
					</div>
				</form>
